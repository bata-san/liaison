!macro NSIS_HOOK_PREUNINSTALL
  ...
  MessageBox MB_YESNO|MB_ICONQUESTION \
    "Liaisonが追加した設定、データ、Ubuntu、Docker、Tailscaleなども一括で削除しますか？$$
$$
［はい］完全削除$$
［いいえ］Liaison本体のみ削除" \
    IDYES liaison_full_cleanup IDNO liaison_basic_cleanup

liaison_full_cleanup:
  MessageBox MB_YESNO|MB_ICONEXCLAMATION \
    "WSLと仮想マシン プラットフォームのWindows機能も無効化しますか？$$
$$
他のアプリがWSLを使用している場合は［いいえ］を選んでください。" \
    IDYES liaison_full_cleanup_features IDNO liaison_full_cleanup_keep_features
